...
# --- DATABASE SOAL BAB 8 - 100% VALID DAN SINKRON ---
if "database_soal" not in st.session_state:
    st.session_state.database_soal = [
        ...
        },
        {
            ...
            "soal": ["休み", "ですから", "確認", "で", "の", "店", "ありません", "はず", "。", "あの", "電話", "今日", "が", "した", "ん", "は", "。"]
        },
        {
            "id": 3, 
            "pola": "Pola 1: 〜はずがない ・ 〜わけがない (Tidak mungkin... / Mustahil...)",
            ...
            "kunci": ["国家", "試験", "な", "の", "だから", "やさしい", "はず", "が", "ない", "。", "... (dan seterusnya)", "……", "。"],
            "soal": ["やさしい", "試験", "国家", "な", "はず", "が", "だから", "ない", "の", "。", "... (dan seterusnya)", "……", "。"]
        },
        {
            "id": 4, 
            "pola": "Pola 1: 〜はずがない ・ 〜わけがない (Tidak mungkin... / Mustahil...)",
        ...
        # --- 2️⃣ 〜とは限らない ---
        {
            ...
            "kanji": "この歌は古くから歌われていますが、日本人がみんな知っているとは限らない。",
        ...
        },
        {
            ...
            "kunci": ["新聞", "に", "書いて", "ある", "こと", "が", "いつも", "本当", "の", "こと", "と", "は", "限らない", "。"],
            "soal": ["新聞", "が", "いつも", "限らない", "本当", "と", "ある", "の", "こと", "に", "は", "書いて", "こと", "は", "。"]
        },
        ...
        },
        {
            ...
            "soal": ["メール", "で", "で", "電話", "いつでも", "お", "わけ", "出られる", "に", "ありません", "は", "します", "は", "願い", "連絡", "。", "。"]
        },
        {
            "id": 12, 
            ...
            "kunci": ["この", "仕事", "が", "好き", "という", "わけ", "で", "は", "ない", "が", "彼", "と", "いっしょ", "に", "仕事", "が", "できて", "楽しい", "。"],
            "soal": ["好き", "が", "ない", "楽しい", "わけ", "仕事", "という", "いっしょ", "この", "が", "で", "彼", "と", "できて", "に", "は", "が", "仕事", "が", "。"]
        },
        {
            "id": 13, 
        ...
        },
        {
            ...
            "kunci": ["Ａ", "「", "いい", "帽子", "ね", "。", "高かった", "でしょう", "。", "」", "Ｂ", "「", "これ", "は", "買った", "ん", "じゃない", "の", "。", "自分", "で", "作った", "の", "。", "」"],
            "soal": ["Ａ", "「", "いい", "帽子", "ね", "。", "高かった", "でしょう", "。", "」", "Ｂ", "「", "これ", "は", "買った", "ん", "じゃない", "の", "。", "自分", "で", "作った", "の", "。", "」"]
        },
        # --- 4️⃣ 〜ないことはない ---
        {
            "id": 15, 
        ...
        },
        {
            ...
            "soal": ["心配", "で", "います", "ない", "試験", "の", "ほっと", "が", "が", "今", "終わって", "して", "は", "ne-ga", "こと", "結果", "は", "。"]
        },
        # --- 5️⃣ 〜ことは〜が、… ---
        {
            "id": 18, 
